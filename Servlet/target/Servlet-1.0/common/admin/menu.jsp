...
<ul
		...
		<div id="collapsePages" class="collapse"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item"
					href='<c:url value = "/admin?action=list&curentPage=1&visiblePage=3&sortBy=id&sortName=desc" />'>Danh sách bài
					viết</a> <a class="collapse-item" href="login.html">Thêm bài viết</a> <a
					class="collapse-item" href="login.html">Cập nhật bài viết</a>
			</div>
		</div></li>
	...
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		<div id="collapseCategory" class="collapse"
			aria-labelledby="headingPages" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item" href="login.html">Danh sách thể loại</a> <a
