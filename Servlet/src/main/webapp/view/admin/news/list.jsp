			...
			<table class="table table-bordered table-fit">
				<thead>
					<tr>
						...
						<th style="width:100px" class="text-center">Tên bài viết</th>
						<th style="width:100px" class="text-center">Thể loại</th>
						<th style="width:200px" class="text-center">Mô tả ngắn</th>
						<th style="width:200px" class="text-center">Truy cập lần cuối</th>
					...
					<c:forEach items="${MODEL.listResult}" var="i">
						<tbody>
							<tr>
								<td >${i.id}</td>
								<td>${i.title}</td>
								<td>${i.categoryModel.categoryType}</td>
